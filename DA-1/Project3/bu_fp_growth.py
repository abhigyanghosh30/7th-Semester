...
Original file is located at
    https://colab.research.google.com/drive/1v9J7C30BJAS0sbyKMADbGg-Seit2qepg
"""
...
def make_tree():
    ...
    for t in db:
        ...
        items.sort(key=lambda x: header[x]['count'], reverse=True)
        curr = root
...
def mine_tree(X, H):
    keys = list(H.keys())
    keys.sort(key=lambda x: H[x]['count'], reverse=True)
    for I in keys:
        if H[I]['count'] >= minsup:
